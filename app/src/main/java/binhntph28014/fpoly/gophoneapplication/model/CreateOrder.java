...
import binhntph28014.fpoly.gophoneapplication.untill.AppInfo;
import binhntph28014.fpoly.gophoneapplication.zalo.Helper.Helpers;
import binhntph28014.fpoly.gophoneapplication.zalo.HttpProvider;
...
public class CreateOrder {
    private class CreateOrderData {
        ...
        private CreateOrderData(String amount) throws Exception {
            ...
            Items = "[]";
            BankCode = "zalopayapp";
            Description = "Geotech Store pay for order #" + Helpers.getAppTransId();
